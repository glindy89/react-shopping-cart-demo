...
{/* Removing this for demo... 
        <div className="notice container">
          A React/Redux shopping cart sample using the full potential of Target Node.js SDK: by prefetching the content for app views on the server-side and injecting these in the content returned on the first page load, you can instantly apply offers on the client-side without any additional calls initiated by Target at.js library.
        </div>
*/}
        <br></br>
